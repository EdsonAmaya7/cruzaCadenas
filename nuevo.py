...
# colum=int(input()) ## numero de palabras para la matriz
...
colum=int(lines)
# print('lineeeeees',colum)
# print('lineeeeees',type(colum))
...
#     print('ciclo formatriz')
#     print(matriz)

with open("cadenas.txt") as archivo:
